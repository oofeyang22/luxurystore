    ...
    <footer>
      <div className='flex flex-col sm:grid grid-cols-[3fr_1fr_1fr] gap-14 my-10 mt-40 text-sm'>
        <div className=''>
          ...
          <p className='w-full md:w-2/3 text-gray-600'>
            Stay connected with Easyshop Clothes for the latest trends, exclusive
      ...
      <div className=''>
        ...
        <p className='py-5 text-sm text-center'>
          {" "}
          Copyright {new Date().getFullYear()} Easyshop - All Right Reserved.{" "}
        </p>
      </div>
    </footer>
  );
